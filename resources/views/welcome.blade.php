                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <li class="nav-item nav-profile dropdown">
                            ...
                            >
                                <img
                                    src="{{
                                        asset('assets/images/faces/face28.jpg')
                                    }}"
                                    alt="profile"
                                />
                            </a>
                    ...
                    <div class="content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-xl-4">
                                        <div class="justify-content-end d-flex">
                                            <div
                                                class="dropdown flex-md-grow-1 flex-xl-grow-0"
                                            >
                                                <button
                        ...
                        <div class="row">
                                ...
                                <div class="card tale-bg">
                                    <div class="card-people mt-auto">
                                        <img
                                            src="{{
                                                asset(
                                                    'assets/images/dashboard/people.svg'
                                                )
                                            }}"
                                            alt="people"
                                        />
                                        <div class="weather-info">
                                            <div class="d-flex">
                                                ...
                                                <div class="ml-2">
                                                    <h4
                                                        class="location font-weight-normal"
                                                    >
                                                        Bangalore
                                                    </h4>
                                                    <h6
                            ...
                            <div class="col-md-6 grid-margin transparent">
                                <div class="row">
                                    <div
                                        class="col-md-6 mb-4 stretch-card transparent"
                                    >
                                ...
                                <div class="row">
                                    <div
                                        class="col-md-6 mb-4 mb-lg-0 stretch-card transparent"
                                    >
                                    ...
                                    <div
                                        class="col-md-6 stretch-card transparent"
                                    >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 stretch-card grid-margin">
                                <div class="row">
                                    ...
                                    >
                                        <div
                                            class="card data-icon-card-primary"
                                        >
                                            <div class="card-body">
                                                <p
                                                ...
                                                <div class="row">
                                                    ...
                                                    >
                                                        <h3>34040</h3>
                                                        <p
                                                            class="text-white font-weight-500 mb-0"
                                                        >
                                                            The total number of
                                                            sessions within the
                                                            date range.It is
